            ...
            <div class="row">
                <div class="col-lg-6 sm-padding">
                    <div class="contact-info">
                        ...
                        <p>
						"Akfast Food serves up delicious, fast, and freshly prepared meals to satisfy every craving. Our menu is crafted with quality ingredients, offering a variety of flavors that everyone loves. Experience quick service without compromising on taste—only at Akfast Food!"
                        </p>
                        <h3>
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6">
                    <div class="footer_widget">
                        <img src="Design/images/logo-img.png" alt="Restaurant Logo" style="width: 150px;margin-bottom: 20px;">
                        <p>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="footer_widget">
                        ...
                        <ul class="opening_time">
                            <li>Monday - Friday 11:30am - 11:00 pm</li>
                            <li>Monday - Friday 11:30am - 11:00 pm</li>
                            <li>Monday - Friday 11:30am - 11:00 pm</li>
                            <li>Monday - Friday 11:30am - 11:00 pm</li>
                        </ul>
